...
#define WORD 258
#define NUMBER 259
#define LH_SQ_BRACKET 260
#define RH_SQ_BRACKET 261
#define COMMA 262
...
{
  "$end", "error", "$undefined", "WORD", "NUMBER", "LH_SQ_BRACKET",
  "RH_SQ_BRACKET", "COMMA", "$accept", "lists", "list", "number_list", YY_NULLPTR
};
#endif
