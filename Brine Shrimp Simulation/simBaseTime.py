...
# File:			simBaseTime.py
# purpose:		simBaseSweep.py with different plot names to distinguish. 
#				Uses default values for everything but time 2 change, and 
#				number of shrimp
# Revisions: 
...
plt.savefig(str(NUMSHRIMP) + "shrimp_" + str(TIME2CHANGE) + ".png")
